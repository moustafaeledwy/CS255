...
class Scheduler:
	...
	def createSchedule(self):
		...
		c = comedian.Comedian(1)
		d = demographic.Demographic(1)
		
		print(canPerform(self, c.themes, d.topics))
	
		#Do not change this line
		return timetableObj

	#this method checks weather or not the chosen comedian and chosen demographic follow the constraints
	def canPerform(self, theme, genre):
		for theme in theme:
			for theme in genre:
				if theme not in genre:
					return False
				else:
					return True	
